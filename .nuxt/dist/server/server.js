...
/******/ 			var chunk = require("./" + ({"1":"components/nuxt-logo","2":"pages/ShowProduct","3":"pages/admin/index","4":"pages/admin/product/add","5":"pages/admin/product/delete","6":"pages/admin/product/edit","7":"pages/admin/product/manager","8":"pages/admin/user/add","9":"pages/admin/user/edit","10":"pages/admin/user/role","11":"pages/admin/user/view","12":"pages/category","13":"pages/index","14":"pages/search","15":"pages/signin","16":"pages/signup"}[chunkId]||chunkId) + ".js");
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Shared/Header.vue?vue&type=template&id=2fd17358&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container-general"},[_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<div class=\"\r\n      \r\n      d-flex\r\n      flex-column flex-md-row\r\n      align-items-center\r\n      p-3\r\n      px-md-4\r\n      mb-3\r\n      bg-white\r\n      border-bottom\r\n      shadow-sm\r\n      background\r\n    \">","</div>",[_vm._ssrNode("<a href=\"http://localhost:3000/\" class=\"my-0 mr-md-auto font-weight-normal\"><img src=\"https://i.ibb.co/hHc1ZKL/logo-quan-game-dep-1024x1024-removebg-preview.png\" class=\"bg-img\"></a> "),_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<input type=\"text\" value placeholder=\"Search...\" class=\"search\"> "),_c('router-link',{attrs:{"to":{ path: '/search/'+ _vm.search }}},[_c('span',{staticStyle:{"font-size":"18px","color":"white"}},[_vm._v("   ⌕  ")])])],2),_vm._ssrNode(" "),_vm._ssrNode("<nav class=\"my-2 my-md-0 mr-md-3\">","</nav>",[_vm._ssrNode("<div class=\"dropdown nav1 \">","</div>",[_vm._ssrNode("<button class=\"nut_dropdown p-2\">Danh Mục+</button> "),_vm._ssrNode("<div class=\"noidung_dropdown\">","</div>",[_c('router-link',{attrs:{"to":{ path: '/category/'+ 1 }}},[_vm._v("Game ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 2 }}},[_vm._v("Game Phiêu Lưu ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 3 }}},[_vm._v("Game Hành Động ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 4 }}},[_vm._v("Game Kinh Dị ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 5 }}},[_vm._v("Game Giải Đố ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 6 }}},[_vm._v("Game Chiến Thuật ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 7 }}},[_vm._v("Game 18+ ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 8 }}},[_vm._v("Game Đối Kháng ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 9 }}},[_vm._v("Game Chặt Chém ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 10 }}},[_vm._v("Game Giả Lập ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 11 }}},[_vm._v("Game Mô Phỏng ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 12 }}},[_vm._v("Game Bắn Súng ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 13 }}},[_vm._v("Game Nhập Vai ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 14 }}},[_vm._v("Game Thể Thao ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 15 }}},[_vm._v("Game Sinh Tồn ")]),_vm._ssrNode(" "),_c('router-link',{attrs:{"to":{ path: '/category/'+ 16 }}},[_vm._v("Game Online ")])],2)],2),_vm._ssrNode(" <a href class=\"p-2 text-light \">Cộng Đồng</a> <a href=\"mailto:thienthotran.it@gmail.com\" class=\"p-2 text-light \">Liên Hệ+</a>")],2),_vm._ssrNode(" "+((_vm.statusLogined==false)?("<a href=\"http://localhost:3000/signin\" class=\"btn btn-outline-primary\">\r\n      Đăng nhập\r\n      </a>"):("<div class=\"navbar-item nav1 dropdown is-hoverable \"><a class=\"navbar-link \"><span class=\"icon is-small is-left\"><i class=\"fab fa-earlybirds\"></i></span>"+_vm._ssrEscape(" Hello, "+_vm._s(_vm.$auth.$state.user.user.Email)+" \r\n            \r\n          ")+"</a> <div class=\"noidung_dropdown\"><a href=\"#\"> Profile </a> "+((_vm.$auth.$state.user.user.Role==1)?("<a href=\"http://localhost:3000/admin\"> Admin </a>"):"<!---->")+" <a style=\"color: red\"> Logout </a></div></div>")))],2)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Shared/Header.vue?vue&type=template&id=2fd17358&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Shared/Header.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var Headervue_type_script_lang_js_ = ({data(){return{statusLogined:this.$auth.loggedIn,search:''};},methods:{}});
// CONCATENATED MODULE: ./components/Shared/Header.vue?vue&type=script&lang=js&
 /* harmony default export */ var Shared_Headervue_type_script_lang_js_ = (Headervue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/Shared/Header.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  Shared_Headervue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Shared/Footer.vue?vue&type=template&id=0fad585d&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('footer',{staticClass:"pt-4 my-md-5 pt-md-5 border-top",staticStyle:{"display":"inline"}},[_vm._ssrNode("<div class=\"row\"><div class=\"col-12 col-md\" style=\"padding-top: 50px\"><img src=\"/docs/4.6/assets/brand/bootstrap-solid.svg\" alt width=\"24\" height=\"24\" class=\"mb-2\"> <div class=\"col-6 col-md block3\"><h5>Thành viên</h5> <ul class=\"list-unstyled text-small\"><li><a href=\"#\" class=\"text-muted\">Trần Hữu Thọ</a></li> <li><a href=\"#\" class=\"text-muted\">Nguyễn Văn Đạt</a></li> <li><a href=\"#\" class=\"text-muted\">Lê Nguyễn Minh Trọng</a></li></ul></div> <div class=\"col-6 col-md block1\"><h5>Liên Hệ</h5> <ul class=\"list-unstyled text-small\"><li><a href=\"#\" class=\"text-muted\">Fix lỗi game</a></li> <li><a href=\"#\" class=\"text-muted\">Email</a></li> <li><a href=\"#\" class=\"text-muted\">Facebook</a></li></ul></div> <div class=\"col-6 col-md block2\"><h5>Thông tin</h5> <ul class=\"list-unstyled text-small\"><li><a href=\"#\" class=\"text-muted\">Trường ĐH Sư Phạm</a></li> <li><a href=\"#\" class=\"text-muted\">Team 4</a></li> <li><a href=\"#\" class=\"text-muted\">3 People</a></li></ul></div> <p><small class=\"d-block mb-3 text-muted center\" style=\"text-align: center\">© 2021</small></p></div></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Shared/Footer.vue?vue&type=template&id=0fad585d&
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("103fa0f3", content, true, context)
};
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("c57a9be2", content, true, context)
};
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("dd0ec69a", content, true, context)
};
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Shared/Admin.vue?vue&type=template&id=1edf37d4&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"bg-main"},[_vm._ssrNode("<div class=\"list_menu_site width_common\"><div class=\"item_menu_site border\"><a href=\"http://localhost:3000/admin\" class=\"menu_cap1 color-text\">Trang chủ Admin <span class=\"icon_carret_down\"></span></a></div> <div class=\"item_menu_site border\"><div class=\"menu_cap1 color-text\">Quản lý User<span class=\"icon_carret_down\"></span></div></div> <div class=\"item_menu_site border\"><a href=\"http://localhost:3000/admin/user/view\" class=\"menu_cap2\">  Tài khoản User<span class=\"icon_carret_down\"></span></a></div> <div class=\"item_menu_site border\"><a href=\"http://localhost:3000/admin/user/role\" class=\"menu_cap2\">  Phân quyền<span class=\"icon_carret_down\"></span></a></div> <div class=\"item_menu_site border\"><a href=\"http://localhost:3000/admin/user/add\" class=\"menu_cap2\">  Tạo tài khoản Admin<span class=\"icon_carret_down\"></span></a></div> <div class=\"item_menu_site border\"><div class=\"menu_cap1 parent_submenu color-text\">Quản lý sản phẩm <span class=\"icon_carret_down\"></span></div></div> <div class=\"item_menu_site border\"><a href=\"http://localhost:3000/admin/product/add\" class=\"menu_cap2\"> Thêm sản phẩm<span class=\"icon_carret_down\"></span></a></div> <div class=\"item_menu_site border\"><a href=\"http://localhost:3000/admin/product/manager\" class=\"menu_cap2\"> Sửa, xóa sản phẩm<span class=\"icon_carret_down\"></span></a></div> <p>   </p> <div><div class=\"item_menu_site\"><a href class=\"menu_cap1 parent_submenu color-text2\">Liên hệ <span class=\"icon_carret_down\"></span></a></div> <div class=\"item_menu_site \"><a href class=\"menu_cap1 parent_submenu color-text2\">Báo cáo vi phạm <span class=\"icon_carret_down\"></span></a></div></div></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Shared/Admin.vue?vue&type=template&id=1edf37d4&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/Shared/Admin.vue
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (async function({$auth,redirect}){console.log($auth.$state.user.Role);const user=await $auth.$state.user.user;console.log("role: ",user.Role);const users=Number(user.Role);if(user&&users===1){console.log(users);}else{redirect('/');alert("Bạn không có quyền truy cập admin");}});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (async function({$auth,redirect}){console.log($auth.$state.user.Role);const user=await $auth.$state.user.user;console.log("role: ",user.Role);const users=Number(user.Role);if(user&&users===0){console.log(users);}else{redirect('/');}});
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".bg-img{max-width:55px;max-height:55px;margin-left:20%}.background{background-color:#1b1d1e!important}.container-general{width:90%!important;margin:1% auto auto}.nut_dropdown{background-color:rgba(0,153,255,.014)!important;color:#3ae8ff;padding:16px;font-size:18px;border:none}.dropdown{position:relative;display:inline-block}.noidung_dropdown{display:none;position:absolute;background-color:rgba(0,0,0,.445);min-width:160px;box-shadow:0 8px 16px 0 rgba(0,0,0,.2);z-index:1}.noidung_dropdown a{color:#fcfcfc;padding:12px 16px;text-decoration:none;display:block}.noidung_dropdown a:hover{background-color:#aa2121}.dropdown:hover .noidung_dropdown{display:block}.dropdown:hover .nut_dropdown{color:red}.search{position:relative;float:left;background:#46524f;color:#3ae8ff}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".row{margin:0}h5{color:#fff}.block1,.block2,.block3{display:inline-block;width:300px;height:150px;padding:5px}.block3{margin-left:20%}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".bg-main{width:250px;background-color:#5a5656}.color-text{color:red}.color-text2{color:#e9e9e9}.block_ct_menu_site{border-bottom:10px solid #f1f1f5}.border{border-top:1px solid #5d6064;border-bottom:1px solid #5d6064}.item_menu_site{width:100%;float:left;position:relative}.item_menu_site .icon_carret_down{position:absolute;right:10px;top:15px;transform:rotate(270deg)}.item_menu_site .menu_cap1 .icon_carret_down{top:20px}.item_menu_site .icon_carret_down:before{background:none;border:1px solid #a0a0a0}.item_menu_site .menu_cap1{font-size:18px;font-weight:700}.item_menu_site .menu_cap2{font-size:14px;color:#fff}.item_menu_site .menu_cap1,.item_menu_site .menu_cap2{display:block;padding:10px}.list_sub_menu_site .menu_cap3{padding:10px 10px 10px 20px;display:block}.list_sub_menu_site .menu_cap2{font-weight:700}.item_menu_site a:hover{background:#e5fbf1;color:#306e51}.item_menu_site a:hover .icon_carret_down:before{border:1px solid #306e51}#wrapper_menu .block_hot_line{border:none;padding:0 10px;margin:0;width:100%}#wrapper_menu .item_hotline{font-size:16px;line-height:16px;margin-left:0;margin-right:5%;width:45%;padding-left:30px}#wrapper_menu .icons_hotline{left:0}#wrapper_menu .item_hotline strong{font-size:20px;line-height:20px}#wrapper_menu .block_sub_menu_site{position:fixed;width:360px;top:-1px;z-index:22;height:100%;left:0;background:#fff;-webkit-overflow-scrolling:touch;transform:translate3d(-200%,0,0);transition:transform .5s cubic-bezier(.16,.68,.43,.99)}#wrapper_menu .show_submenu .block_sub_menu_site{transform:translateZ(0)}#wrapper_menu .item_back_sub_menu .back_sub_menu{padding:10px;display:block;border-bottom:10px solid #f1f1f5;font-size:14px;font-weight:700}#wrapper_menu .icon_back{margin-right:10px;margin-top:-3px}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".bg-color{background-color:#3e3e97}.bg-color2{background-color:#333435}.bg-color3{background-color:#1a1a1a}.bl-main{position:relative}.bl-0,.bl-main{display:inline}.bl-1{width:250px;position:static}.bl-1,div.bl-2{display:inline-block;margin-left:70px}div.bl-2{overflow:visible;position:absolute}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".bg-color{background-color:#3e3e97}.bg-color2{background-color:#333435}.bg-color3{background-color:#1a1a1a}.container-general{width:90%!important}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
__webpack_require__.d(components_namespaceObject, "SharedAdmin", function() { return SharedAdmin; });
__webpack_require__.d(components_namespaceObject, "SharedFooter", function() { return SharedFooter; });
__webpack_require__.d(components_namespaceObject, "SharedHeader", function() { return SharedHeader; });
...
const middleware={};middleware['authAdmin']=__webpack_require__(29);middleware['authAdmin']=middleware['authAdmin'].default||middleware['authAdmin'];middleware['authUser']=__webpack_require__(30);middleware['authUser']=middleware['authUser'].default||middleware['authUser'];/* harmony default export */ var _nuxt_middleware = (middleware);
...
const _1c8d9ac2=()=>interopDefault(__webpack_require__.e(/* import() | pages/admin/index */ 3).then(__webpack_require__.bind(null, 100)));const _305c98fa=()=>interopDefault(__webpack_require__.e(/* import() | pages/category */ 12).then(__webpack_require__.bind(null, 101)));const _1782b4b8=()=>interopDefault(__webpack_require__.e(/* import() | pages/search */ 14).then(__webpack_require__.bind(null, 102)));const _1e49c1c6=()=>interopDefault(__webpack_require__.e(/* import() | pages/ShowProduct */ 2).then(__webpack_require__.bind(null, 103)));const _28dfbac4=()=>interopDefault(__webpack_require__.e(/* import() | pages/signin */ 15).then(__webpack_require__.bind(null, 104)));const _00267914=()=>interopDefault(__webpack_require__.e(/* import() | pages/signup */ 16).then(__webpack_require__.bind(null, 105)));const _bc74fd56=()=>interopDefault(__webpack_require__.e(/* import() | pages/admin/product/add */ 4).then(__webpack_require__.bind(null, 106)));const _dfb7f2b2=()=>interopDefault(__webpack_require__.e(/* import() | pages/admin/product/delete */ 5).then(__webpack_require__.bind(null, 99)));const _42b15086=()=>interopDefault(__webpack_require__.e(/* import() | pages/admin/product/edit */ 6).then(__webpack_require__.bind(null, 107)));const _879bf73e=()=>interopDefault(__webpack_require__.e(/* import() | pages/admin/product/manager */ 7).then(__webpack_require__.bind(null, 108)));const _f22be4fa=()=>interopDefault(__webpack_require__.e(/* import() | pages/admin/user/add */ 8).then(__webpack_require__.bind(null, 109)));const _021e4a18=()=>interopDefault(__webpack_require__.e(/* import() | pages/admin/user/edit */ 9).then(__webpack_require__.bind(null, 110)));const _da8572f8=()=>interopDefault(__webpack_require__.e(/* import() | pages/admin/user/role */ 10).then(__webpack_require__.bind(null, 111)));const _2c2f5d9a=()=>interopDefault(__webpack_require__.e(/* import() | pages/admin/user/view */ 11).then(__webpack_require__.bind(null, 112)));const _0a98c486=()=>interopDefault(__webpack_require__.e(/* import() | pages/index */ 13).then(__webpack_require__.bind(null, 113)));const emptyFn=()=>{};external_vue_default.a.use(external_vue_router_default.a);const routerOptions={mode:'history',base:'/',linkActiveClass:'nuxt-link-active',linkExactActiveClass:'nuxt-link-exact-active',scrollBehavior: router_scrollBehavior,routes:[{path:'/admin',component:_1c8d9ac2,name:'admin'},{path:'/category/:id',component:_305c98fa,name:'category'},{path:'/search/:id',component:_1782b4b8,name:'search'},{path:'/show/:id',component:_1e49c1c6,name:'ShowProduct'},{path:'/signin',component:_28dfbac4,name:'signin'},{path:'/signup',component:_00267914,name:'signup'},{path:'/admin/product/add/',component:_bc74fd56,name:'admin-product-add'},{path:'/admin/product/delete',component:_dfb7f2b2,name:'admin-product-delete'},{path:'/admin/product/edit/:id',component:_42b15086,name:'admin-product-edit'},{path:'/admin/product/manager',component:_879bf73e,name:'admin-product-manager'},{path:'/admin/user/add',component:_f22be4fa,name:'admin-user-add'},{path:'/admin/user/edit/:id',component:_021e4a18,name:'admin-user-edit'},{path:'/admin/user/role',component:_da8572f8,name:'admin-user-role'},{path:'/admin/user/view',component:_2c2f5d9a,name:'admin-user-view'},{path:'/',component:_0a98c486,name:'index'}],fallback:false};function createRouter(ssrContext,config){const base=config._app&&config._app.basePath||routerOptions.base;const router=new external_vue_router_default.a({...routerOptions,base});// TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/admin.vue?vue&type=template&id=5eca141b&
var adminvue_type_template_id_5eca141b_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"bg-color2"},[_vm._ssrNode("<div class=\"cotainer-general\">","</div>",[_vm._ssrNode("<div class=\"bg-color bl-0\">","</div>",[_c('Header')],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"bl-main\">","</div>",[_vm._ssrNode("<div class=\"bg-color bl-1\">","</div>",[_c('Admin')],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"bg-color2 bl-2\">","</div>",[_c('Nuxt')],1)],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"bg-color3 bl-0\">","</div>",[_c('Footer')],1)],2)])}
var adminvue_type_template_id_5eca141b_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/admin.vue?vue&type=template&id=5eca141b&

// EXTERNAL MODULE: ./components/Shared/Header.vue + 4 modules
var Header = __webpack_require__(7);

// EXTERNAL MODULE: ./components/Shared/Footer.vue + 4 modules
var Footer = __webpack_require__(8);

// EXTERNAL MODULE: ./components/Shared/Admin.vue + 2 modules
var Admin = __webpack_require__(26);
...
//
// import conponent
/* harmony default export */ var adminvue_type_script_lang_js_ = ({name:'Default',// decleare component
components:{Header: Header["default"],Admin: Admin["default"],Footer: Footer["default"]}});
...
var admin_component = Object(componentNormalizer["a" /* default */])(
  ...
  adminvue_type_template_id_5eca141b_render,
  adminvue_type_template_id_5eca141b_staticRenderFns,
  false,
  admin_injectStyles,
  null,
  "5ec0a1b3"
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=1a244b00&
var defaultvue_type_template_id_1a244b00_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"bg-color2"},[_vm._ssrNode("<div class=\"cotainer-general\">","</div>",[_vm._ssrNode("<div class=\"bg-color\">","</div>",[_c('Header')],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"bg-color2\">","</div>",[_c('Nuxt')],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"bg-color3\">","</div>",[_c('Footer')],1)],2)])}
var defaultvue_type_template_id_1a244b00_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=1a244b00&
...
//
// import conponent
/* harmony default export */ var defaultvue_type_script_lang_js_ = ({name:'Default',// decleare component
components:{Header: Header["default"],Footer: Footer["default"]}});
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_1a244b00_render,
  defaultvue_type_template_id_1a244b00_staticRenderFns,
  false,
...
const layouts={"_admin":sanitizeComponent(admin),"_default":sanitizeComponent(layouts_default)};/* harmony default export */ var App = ({render(h,props){const loadingEl=h('NuxtLoading',{ref:'loading'});const layoutEl=h(this.layout||'nuxt');const templateEl=h('div',{domProps:{id:'__layout'},key:this.layoutName},[layoutEl]);const transitionEl=h('transition',{props:{name:'layout',mode:'out-in'},on:{beforeEnter(el){// Ensure to trigger scroll event after calling scrollBehavior
...
external_vue_default.a.use(external_vuex_default.a);let store_store={};(function updateModules(){store_store=normalizeRoot(__webpack_require__(49),'store/index.js');// If store is an exported method = classic mode (deprecated)
...
const NuxtLogo=()=>__webpack_require__.e(/* import() | components/nuxt-logo */ 1).then(__webpack_require__.bind(null, 114)).then(c=>wrapFunctional(c.default||c));const SharedAdmin=()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 26)).then(c=>wrapFunctional(c.default||c));const SharedFooter=()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 8)).then(c=>wrapFunctional(c.default||c));const SharedHeader=()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 7)).then(c=>wrapFunctional(c.default||c));// nuxt/nuxt.js#8607
...
const baseURL= false?undefined:runtimeConfig.baseURL||runtimeConfig.baseUrl||process.env._AXIOS_BASE_URL_||'http://localhost:5000/api';// Create fresh objects for all default header scopes
// Axios creates only one which is shared across SSR requests!
// https://github.com/mzabriskie/axios/blob/master/lib/defaults.js
const headers={"common":{"Accept":"application/json, text/plain, */*"},"delete":{},"get":{},"head":{},"post":{},"put":{},"patch":{}};const axiosOptions={baseURL,headers};if(true){// Don't accept brotli encoding because Node can't parse it
...
var external_vuelidate_ = __webpack_require__(25);
...
const isUnset=o=>typeof o==='undefined'||o===null;const isSet=o=>!isUnset(o);const isSameURL=(a,b)=>a.split('?')[0].replace(/\/+$/,'')===b.split('?')[0].replace(/\/+$/,'');const isRelativeURL=u=>u&&u.length&&/^\/([a-zA-Z0-9@\-%_~][/a-zA-Z0-9@\-%_~]*)?([?][^#]*)?(#[^#]*)?$/.test(u);const parseQuery=queryString=>{const query={};const pairs=queryString.split('&');for(let i=0;i<pairs.length;i++){const pair=pairs[i].split('=');query[decodeURIComponent(pair[0])]=decodeURIComponent(pair[1]||'');}return query;};const encodeQuery=queryObject=>{return Object.entries(queryObject).filter(([key,value])=>typeof value!=='undefined').map(([key,value])=>encodeURIComponent(key)+(value!=null?'='+encodeURIComponent(value):'')).join('&');};const routeOption=(route,key,value)=>{return route.matched.some(m=>{if(false){}else{// SSR
return Object.values(m.components).some(component=>Object.values(component._Ctor).some(ctor=>ctor.options&&ctor.options[key]===value));}});};const utilities_getMatchedComponents=(route,matches=false)=>{return[].concat.apply([],route.matched.map(function(m,index){return Object.keys(m.components).map(function(key){matches&&matches.push(index);return m.components[key];});}));};function normalizePath(path=''){// Remove query string
let result=path.split('?')[0];// Remove redundant / from the end of path
if(result.charAt(result.length-1)==='/'){result=result.slice(0,-1);}return result;}function encodeValue(val){if(typeof val==='string'){return val;}return JSON.stringify(val);}function decodeValue(val){// Try to parse as json
if(typeof val==='string'){try{return JSON.parse(val);}catch(_){}}// Return as is
return val;}/**
 ...
 */function getProp(holder,propName){if(!propName||!holder){return holder;}if(propName in holder){return holder[propName];}const propParts=Array.isArray(propName)?propName:(propName+'').split('.');let result=holder;while(propParts.length&&result){result=result[propParts.shift()];}return result;}
// CONCATENATED MODULE: ./.nuxt/auth/storage.js
class storage_Storage{constructor(ctx,options){this.ctx=ctx;this.options=options;this._initState();}// ------------------------------------
// Universal
// ------------------------------------
setUniversal(key,value){// Unset null, undefined
if(isUnset(value)){return this.removeUniversal(key);}// Local state
this.setState(key,value);// Cookies
this.setCookie(key,value);// Local Storage
this.setLocalStorage(key,value);return value;}getUniversal(key){// Local state
let value=this.getState(key);// Cookies
if(isUnset(value)){value=this.getCookie(key);}// Local Storage
if(isUnset(value)){value=this.getLocalStorage(key);}return value;}syncUniversal(key,defaultValue){let value=this.getUniversal(key);if(isUnset(value)&&isSet(defaultValue)){value=defaultValue;}if(isSet(value)){this.setUniversal(key,value);}return value;}removeUniversal(key){this.removeState(key);this.removeLocalStorage(key);this.removeCookie(key);}// ------------------------------------
// Local state (reactive)
// ------------------------------------
_initState(){// Private state is suitable to keep information not being exposed to Vuex store
...
this._useVuex=this.options.vuex&&this.ctx.store;if(this._useVuex){const storeModule={namespaced:true,state:()=>this.options.initialState,mutations:{SET(state,payload){external_vue_default.a.set(state,payload.key,payload.value);}}};this.ctx.store.registerModule(this.options.vuex.namespace,storeModule,{preserveState:Boolean(this.ctx.store.state[this.options.vuex.namespace])});this.state=this.ctx.store.state[this.options.vuex.namespace];}else{external_vue_default.a.set(this,'state',{});}}setState(key,value){if(key[0]==='_'){external_vue_default.a.set(this._state,key,value);}else{if(this._useVuex){this.ctx.store.commit(this.options.vuex.namespace+'/SET',{key,value});}else{external_vue_default.a.set(this.state,key,value);}}return value;}getState(key){if(key[0]!=='_'){return this.state[key];}else{return this._state[key];}}watchState(key,fn){if(this._useVuex){return this.ctx.store.watch(state=>getProp(state[this.options.vuex.namespace],key),fn);}}removeState(key){this.setState(key,undefined);}// ------------------------------------
// Local storage
// ------------------------------------
setLocalStorage(key,value){// Unset null, undefined
if(isUnset(value)){return this.removeLocalStorage(key);}if(typeof localStorage==='undefined'||!this.options.localStorage){return;}const _key=this.options.localStorage.prefix+key;try{localStorage.setItem(_key,encodeValue(value));}catch(e){if(!this.options.ignoreExceptions){throw e;}}return value;}getLocalStorage(key){if(typeof localStorage==='undefined'||!this.options.localStorage){return;}const _key=this.options.localStorage.prefix+key;const value=localStorage.getItem(_key);return decodeValue(value);}removeLocalStorage(key){if(typeof localStorage==='undefined'||!this.options.localStorage){return;}const _key=this.options.localStorage.prefix+key;localStorage.removeItem(_key);}// ------------------------------------
// Cookies
// ------------------------------------
getCookies(){const cookieStr= false?undefined:this.ctx.req.headers.cookie;return Object(external_cookie_["parse"])(cookieStr||'')||{};}setCookie(key,value,options={}){if(!this.options.cookie|| true&&!this.ctx.res){return;}const _key=this.options.cookie.prefix+key;const _options=Object.assign({},this.options.cookie.options,options);const _value=encodeValue(value);// Unset null, undefined
if(isUnset(value)){_options.maxAge=-1;}// Accept expires as a number for js-cookie compatiblity
if(typeof _options.expires==='number'){_options.expires=new Date(new Date()*1+_options.expires*864e+5);}const serializedCookie=Object(external_cookie_["serialize"])(_key,_value,_options);if(false){}else if( true&&this.ctx.res){// Send Set-Cookie header from server side
const prevCookies=this.ctx.res.getHeader('Set-Cookie');this.ctx.res.setHeader('Set-Cookie',[].concat(prevCookies,serializedCookie).filter(v=>v));}return value;}getCookie(key){if(!this.options.cookie|| true&&!this.ctx.req){return;}const _key=this.options.cookie.prefix+key;const cookies=this.getCookies();const value=cookies[_key]?decodeURIComponent(cookies[_key]):undefined;return decodeValue(value);}removeCookie(key,options){this.setCookie(key,undefined,options);}}
// CONCATENATED MODULE: ./.nuxt/auth/auth.js
class auth_Auth{constructor(ctx,options){this.ctx=ctx;this.options=options;// Strategies
this.strategies={};// Error listeners
this._errorListeners=[];// Redirect listeners
this._redirectListeners=[];// Storage & State
options.initialState={user:null,loggedIn:false};const storage=new storage_Storage(ctx,options);this.$storage=storage;this.$state=storage.state;}async init(){// Reset on error
if(this.options.resetOnError){this.onError((...args)=>{if(typeof this.options.resetOnError!=='function'||this.options.resetOnError(...args)){this.reset();}});}// Restore strategy
this.$storage.syncUniversal('strategy',this.options.defaultStrategy);// Set default strategy if current one is invalid
if(!this.strategy){this.$storage.setUniversal('strategy',this.options.defaultStrategy);// Give up if still invalid
if(!this.strategy){return Promise.resolve();}}try{// Call mounted for active strategy on initial load
await this.mounted();}catch(error){this.callOnError(error);}finally{// Watch for loggedIn changes only in client side
if(false){}}}// Backward compatibility
get state(){if(!this._state_warn_shown){this._state_warn_shown=true;// eslint-disable-next-line no-console
console.warn('[AUTH] $auth.state is deprecated. Please use $auth.$state or top level props like $auth.loggedIn');}return this.$state;}getState(key){if(!this._get_state_warn_shown){this._get_state_warn_shown=true;// eslint-disable-next-line no-console
console.warn('[AUTH] $auth.getState is deprecated. Please use $auth.$storage.getState() or top level props like $auth.loggedIn');}return this.$storage.getState(key);}// ---------------------------------------------------------------
// Strategy and Scheme
// ---------------------------------------------------------------
get strategy(){return this.strategies[this.$state.strategy];}registerStrategy(name,strategy){this.strategies[name]=strategy;}setStrategy(name){if(name===this.$storage.getUniversal('strategy')){return Promise.resolve();}// Set strategy
this.$storage.setUniversal('strategy',name);// Call mounted hook on active strategy
return this.mounted();}mounted(){if(!this.strategy.mounted){return this.fetchUserOnce();}return Promise.resolve(this.strategy.mounted(...arguments)).catch(error=>{this.callOnError(error,{method:'mounted'});return Promise.reject(error);});}loginWith(name,...args){return this.setStrategy(name).then(()=>this.login(...args));}login(){if(!this.strategy.login){return Promise.resolve();}return this.wrapLogin(this.strategy.login(...arguments)).catch(error=>{this.callOnError(error,{method:'login'});return Promise.reject(error);});}fetchUser(){if(!this.strategy.fetchUser){return Promise.resolve();}return Promise.resolve(this.strategy.fetchUser(...arguments)).catch(error=>{this.callOnError(error,{method:'fetchUser'});return Promise.reject(error);});}logout(){if(!this.strategy.logout){this.reset();return Promise.resolve();}return Promise.resolve(this.strategy.logout(...arguments)).catch(error=>{this.callOnError(error,{method:'logout'});return Promise.reject(error);});}setUserToken(token){if(!this.strategy.setUserToken){this.setToken(this.strategy.name,token);return Promise.resolve();}return Promise.resolve(this.strategy.setUserToken(token)).catch(error=>{this.callOnError(error,{method:'setUserToken'});return Promise.reject(error);});}reset(){if(!this.strategy.reset){this.setUser(false);this.setToken(this.$state.strategy,false);this.setRefreshToken(this.$state.strategy,false);return Promise.resolve();}return Promise.resolve(this.strategy.reset(...arguments)).catch(error=>{this.callOnError(error,{method:'reset'});return Promise.reject(error);});}// ---------------------------------------------------------------
// Token helpers
// ---------------------------------------------------------------
getToken(strategy){const _key=this.options.token.prefix+strategy;return this.$storage.getUniversal(_key);}setToken(strategy,token){const _key=this.options.token.prefix+strategy;return this.$storage.setUniversal(_key,token);}syncToken(strategy){const _key=this.options.token.prefix+strategy;return this.$storage.syncUniversal(_key);}// ---------------------------------------------------------------
// Refresh token helpers
// ---------------------------------------------------------------
getRefreshToken(strategy){const _key=this.options.refresh_token.prefix+strategy;return this.$storage.getUniversal(_key);}setRefreshToken(strategy,refreshToken){const _key=this.options.refresh_token.prefix+strategy;return this.$storage.setUniversal(_key,refreshToken);}syncRefreshToken(strategy){const _key=this.options.refresh_token.prefix+strategy;return this.$storage.syncUniversal(_key);}// ---------------------------------------------------------------
// User helpers
// ---------------------------------------------------------------
get user(){return this.$state.user;}get loggedIn(){return this.$state.loggedIn;}fetchUserOnce(){if(!this.$state.user){return this.fetchUser(...arguments);}return Promise.resolve();}setUser(user){this.$storage.setState('user',user);this.$storage.setState('loggedIn',Boolean(user));}// ---------------------------------------------------------------
// Utils
// ---------------------------------------------------------------
get busy(){return this.$storage.getState('busy');}request(endpoint,defaults,withResponse){const _endpoint=typeof defaults==='object'?Object.assign({},defaults,endpoint):endpoint;if(!this.ctx.app.$axios){// eslint-disable-next-line no-console
console.error('[AUTH] add the @nuxtjs/axios module to nuxt.config file');return;}return this.ctx.app.$axios.request(_endpoint).then(response=>{const result=_endpoint.propertyName?getProp(response.data,_endpoint.propertyName):response.data;if(withResponse){return{response,result};}else{return result;}}).catch(error=>{// Call all error handlers
this.callOnError(error,{method:'request'});// Throw error
return Promise.reject(error);});}requestWith(strategy,endpoint,defaults,withResponse){const token=this.getToken(strategy);const _endpoint=Object.assign({},defaults,endpoint);const tokenName=this.strategies[strategy].options.tokenName||'Authorization';if(!_endpoint.headers){_endpoint.headers={};}if(!_endpoint.headers[tokenName]&&isSet(token)&&token){_endpoint.headers[tokenName]=token;}return this.request(_endpoint,false,withResponse);}wrapLogin(promise){this.$storage.setState('busy',true);this.error=null;return Promise.resolve(promise).then(response=>{this.$storage.setState('busy',false);return response;}).catch(error=>{this.$storage.setState('busy',false);return Promise.reject(error);});}onError(listener){this._errorListeners.push(listener);}callOnError(error,payload={}){this.error=error;for(const fn of this._errorListeners){fn(error,payload);}}redirect(name,noRouter=false){if(!this.options.redirect){return;}const from=this.options.fullPathRedirect?this.ctx.route.fullPath:this.ctx.route.path;let to=this.options.redirect[name];if(!to){return;}// Apply rewrites
if(this.options.rewriteRedirects){if(name==='login'&&isRelativeURL(from)&&!isSameURL(to,from)){this.$storage.setUniversal('redirect',from);}if(name==='home'){const redirect=this.$storage.getUniversal('redirect');this.$storage.setUniversal('redirect',null);if(isRelativeURL(redirect)){to=redirect;}}}// Call onRedirect hook
to=this.callOnRedirect(to,from)||to;// Prevent infinity redirects
if(isSameURL(to,from)){return;}if(false){}else{this.ctx.redirect(to,this.ctx.query);}}onRedirect(listener){this._redirectListeners.push(listener);}callOnRedirect(to,from){for(const fn of this._redirectListeners){to=fn(to,from)||to;}return to;}hasScope(scope){const userScopes=this.$state.user&&getProp(this.$state.user,this.options.scopeKey);if(!userScopes){return false;}if(Array.isArray(userScopes)){return userScopes.includes(scope);}return Boolean(getProp(userScopes,scope));}}
// CONCATENATED MODULE: ./.nuxt/auth/middleware.js
_nuxt_middleware.auth=function(ctx){// Disable middleware if options: { auth: false } is set on the route
if(routeOption(ctx.route,'auth',false)){return;}// Disable middleware if no route was matched to allow 404/error page
const matches=[];const Components=utilities_getMatchedComponents(ctx.route,matches);if(!Components.length){return;}const{login,callback}=ctx.$auth.options.redirect;const pageIsInGuestMode=routeOption(ctx.route,'auth','guest');const insidePage=page=>normalizePath(ctx.route.path)===normalizePath(page);if(ctx.$auth.$state.loggedIn){// -- Authorized --
if(!login||insidePage(login)||pageIsInGuestMode){ctx.$auth.redirect('home');}}else{// -- Guest --
// (Those passing `callback` at runtime need to mark their callback component
// with `auth: false` to avoid an unnecessary redirect from callback to login)
if(!pageIsInGuestMode&&(!callback||!insidePage(callback))){ctx.$auth.redirect('login');}}};
// CONCATENATED MODULE: ./.nuxt/auth/schemes/local.js
class LocalScheme{constructor(auth,options){this.$auth=auth;this.name=options._name;this.options=Object.assign({},DEFAULTS,options);}_setToken(token){if(this.options.globalToken){// Set Authorization token for all axios requests
this.$auth.ctx.app.$axios.setHeader(this.options.tokenName,token);}}_clearToken(){if(this.options.globalToken){// Clear Authorization token for all axios requests
this.$auth.ctx.app.$axios.setHeader(this.options.tokenName,false);}}mounted(){if(this.options.tokenRequired){const token=this.$auth.syncToken(this.name);this._setToken(token);}return this.$auth.fetchUserOnce();}async login(endpoint){if(!this.options.endpoints.login){return;}// Ditch any leftover local tokens before attempting to log in
await this.$auth.reset();const{response,result}=await this.$auth.request(endpoint,this.options.endpoints.login,true);if(this.options.tokenRequired){const token=this.options.tokenType?this.options.tokenType+' '+result:result;this.$auth.setToken(this.name,token);this._setToken(token);}if(this.options.autoFetchUser){await this.fetchUser();}return response;}async setUserToken(tokenValue){const token=this.options.tokenType?this.options.tokenType+' '+tokenValue:tokenValue;this.$auth.setToken(this.name,token);this._setToken(token);return this.fetchUser();}async fetchUser(endpoint){// Token is required but not available
if(this.options.tokenRequired&&!this.$auth.getToken(this.name)){return;}// User endpoint is disabled.
if(!this.options.endpoints.user){this.$auth.setUser({});return;}// Try to fetch user and then set
const user=await this.$auth.requestWith(this.name,endpoint,this.options.endpoints.user);this.$auth.setUser(user);}async logout(endpoint){// Only connect to logout endpoint if it's configured
if(this.options.endpoints.logout){await this.$auth.requestWith(this.name,endpoint,this.options.endpoints.logout).catch(()=>{});}// But reset regardless
return this.$auth.reset();}async reset(){if(this.options.tokenRequired){this._clearToken();}this.$auth.setUser(false);this.$auth.setToken(this.name,false);this.$auth.setRefreshToken(this.name,false);return Promise.resolve();}}const DEFAULTS={tokenRequired:true,tokenType:'Bearer',globalToken:true,tokenName:'Authorization',autoFetchUser:true};
// CONCATENATED MODULE: ./.nuxt/auth/plugin.js
// Active schemes
/* harmony default export */ var auth_plugin = (function(ctx,inject){// Options
const options={"resetOnError":false,"scopeKey":"scope","rewriteRedirects":true,"fullPathRedirect":false,"watchLoggedIn":true,"redirect":{"login":"/signin","logout":"/signin","home":"/","callback":"/signin"},"vuex":{"namespace":"auth"},"cookie":{"prefix":"auth.","options":{"path":"/"}},"localStorage":{"prefix":"auth."},"token":{"prefix":"_token."},"refresh_token":{"prefix":"_refresh_token."},"defaultStrategy":"local"};// Create a new Auth instance
const $auth=new auth_Auth(ctx,options);// Register strategies
// local
$auth.registerStrategy('local',new LocalScheme($auth,{"endpoints":{"login":{"url":"account/signin","method":"post","propertyName":"token"},"logout":{"url":"/api/auth/logout","method":"post"},"user":{"url":"account/user","method":"get","propertyName":false}},"tokenType":"","logout":false,"_name":"local"}));// Inject it to nuxt context as $auth
...
// Source: ..\\plugins\\sweetalert2 (mode: 'client')
